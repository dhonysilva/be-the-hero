...
function resize({ input, quality = 100 }, { background, position, fit, width, height = jimp_1.default.AUTO }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (fit === 'cover') {
            return yield initialImage.cover(width, height, jimpPosition).quality(jimpQuality);
        }
        else if (fit === 'contain') {
            let resizedImage = yield initialImage.contain(width, height, jimpPosition).quality(jimpQuality);
            if (background) {
                resizedImage = yield resizedImage.background(jimp_1.default.cssColorToHex(background));
            }
            return resizedImage;
        }
        else {
